...
const VALID_TOURS = ["welcome-tour", "threat-intel-update-v1", "whats-new-apr-2026", "dashboard-tour", "vulnerabilities-tour", "analytics-tour", "threat-intelligence-tour"] as const;
